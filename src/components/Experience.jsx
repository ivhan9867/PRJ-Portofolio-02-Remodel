...
export default function Experience() {
  ...
  return (
    <section id="experience" className="relative z-10 px-6 md:px-10 py-14 md:py-20">
      <div ref={ref} className="mb-6"
        style={{ opacity:inView?1:0, transform:inView?'translateY(0)':'translateY(16px)', transition:'all 0.5s ease' }}>
        <h2 className="font-display font-bold text-[clamp(1.6rem,4vw,2.6rem)] text-[#e8e6f0]">Experience</h2>
      </div>
        ...
        {JOBS.map((job,i) => (
          <div
            ...
            style={{
              ...
              transition: `opacity 0.45s ${0.08+i*0.07}s ease, transform 0.45s ${0.08+i*0.07}s ease`,
            }}
          >
